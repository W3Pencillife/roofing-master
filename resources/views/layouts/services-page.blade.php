...
<head>
    ...
    <style>
        ...
        .hero {
            ...
            url('{{ $post->image ? asset("images/".$post->image) : "https://picsum.photos/1200/600" }}');
        ...
        .section-title:after { content: ''; position: absolute; bottom: 0; left: 50%; transform: translateX(-50%); width: 80px; height: 3px; background-color: var(--accent-color); }
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-6" data-aos="fade-left" data-aos-duration="1000">
                    <img src="{{ $post->image ? asset('images/'.$post->image) : 'https://picsum.photos/600/400' }}" alt="Post Image" class="img-fluid rounded">
                </div>
            </div>
        </div>
    </section>

    <!-- Pricing / Subcontent2 Section -->
